      ...
      <div className='experience-list section__padding'>
        <div className='experience-item'>
          <div className='item-content'>
            ...
            <p><span className='date'>April 2023 till present</span><br/><br/>Collaborate on software component integration, develop schematics, PCB layouts, documentation, collaborate with Electrical team, mechanical, and software engineers for cost-effective design requirements.</p>
          </div>
        </div>
        <div className='experience-item'>
          <div className='item-content'>
            ...
            <p><span className='date'>October 2022 - April 2023</span><br/><br/>Manage project work flow, trafficking, and communication to maintain deadlines. Coordinate material movement, schedule deliveries, and ensure compliance with material requests. Utilize Excel and Hilti for project scheduling and inventory. Advise management of progress and product delays.</p>
          </div>
        </div>
        <div className='experience-item'>
          <div className='item-content'>
        ...
        <div className='experience-item'>
          ...
          <h2>Mysa Smart Thermostats<br/><span className='smaller'>Engineering Student, Hardware Team</span></h2>
           ...
           <p><span className='date'>May 2020 - August 2020</span><br/><br/>Created Bill of material (BOM) for Fresnel lens project, sourced components, participated in firmware development, designed PCB board, and worked with Arduino IDE software. Assembled Prusa mini 3D printers and printed models for ongoing projects.</p>
          </div>
        </div>
